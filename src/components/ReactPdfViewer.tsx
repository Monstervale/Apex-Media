...
export default function ReactPdfViewer({ file }: { file: string }) {
    ...
    return (
        <Document className={"flex flex-col max-w-[1440px] gap-4 w-full items-center justify-center"} file={file} onLoadError={console.error} onLoadSuccess={onDocumentLoadSuccess}>
